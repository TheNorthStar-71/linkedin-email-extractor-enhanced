...
def find_vanessa_accurate():
    ...
    print("🔍 Finding Vanessa Ramirez's Email (Accurate Search)")
    print("=" * 50)
    
    # Use correct name and try to find company info
    person_info = {
        'name': 'Vanessa Ramirez',
        'username': 'vanessa-ramirez-96135798',
    ...
    # Add specific patterns for Vanessa Ramirez
    name_parts = person_info['name'].lower().split()
    if len(name_parts) >= 2:
        first_name, last_name = name_parts[0], name_parts[-1]
        
        # Common email patterns for Vanessa Ramirez
        specific_patterns = [
